...
* По описанию ps из man:

S- спящие процессы  
R- запущенный или доступный для выполнения (в очереди выполнения)  

* Если же смотреть глазами на процессы, то еще есть много :  

I- простаиваю в потоке ядра  

* А вообще они все вот такие:  

D непрерывный режим сна (обычно ввод-вывод)
I простаиваю в потоке ядра
R запущенный или доступный для выполнения (в очереди выполнения)
S прерываемый спящий режим (ожидание завершения события)
T остановлено сигналом управления заданием
t остановлено отладчиком во время трассировки
W подкачка страниц (недопустима начиная с ядра 2.6.xx)
X мертв (никогда не должен быть замечен)
Z несуществующий ("зомби") процесс, завершенный, но не возвращенный его родителем
